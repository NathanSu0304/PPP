...
//        printData();
    ...
    public static void batchInsert(String fileName) throws ClassNotFoundException, IllegalAccessException, InstantiationException, IOException, SQLException {
        ...
        if(fileName.equals("actor.txt")){
            ...
            HashMap<Integer, String> insertGim = new HashMap<Integer, String>();
            ...
            while ((st = br.readLine()) != null) {
                ...
                gen_id = temp[0];
                mv_id = temp[1];
                insertGim.put(Integer.parseInt(gen_id), mv_id);
            }
            ...
            try {
                ...
                for(Integer key: insertGim.keySet()) {
                    psInsertRecord.setInt(1, key);
                    psInsertRecord.setString(2,insertGim.get(key));
                    psInsertRecord.addBatch();
